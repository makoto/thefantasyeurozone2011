(function() {
  $(document).ready(function() {
    ...
    aggregate = {};
    for (_k = 0, _len3 = countries.length; _k < _len3; _k++) {
      country = countries[_k];
